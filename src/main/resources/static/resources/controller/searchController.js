        ...
        async function addMarker(arrDestinations) {
            ...
            for (var i = 0; i < arrDestinations.length; i++) {
                ...
                if(arrDestinations[i].isForSell === 'Y' && arrDestinations[i].marketBasedEst !== 0) {
                    htmlContent = "<a href=\"#business_details/" + arrDestinations[i].businessId + "\"><img src=\"" + arrDestinations[i].imageFirst + "\" style=\"width:200px;height:100px\" class=\"img-fluid\" alt=\"\"><p style=\"margin:0px;color:black;\">" + arrDestinations[i].name + "</p><p ng-if=\"arrDestinations[i].isForSell === \'Y\'\" style=\"margin:0px;color:black;\">" + "Asking Price: $" + arrDestinations[i].forSellPrice + "</p><p style=\"margin:0px;color:Blue;\">" + "RealWorth&trade; & more details!"+"</p>"
//                } else if (arrDestinations[i].isForSell === 'N' && arrDestinations[i].marketBasedEst !== 0) {
//                    htmlContent = "<a href=\"#business_details/" + arrDestinations[i].businessId + "\"><img src=\"" + arrDestinations[i].imageFirst + "\" style=\"width:200px;height:100px\" class=\"img-fluid\" alt=\"\"><p style=\"margin:0px;color:black;\">" + arrDestinations[i].name + "</p><p style=\"margin:0px;color:blue;\">" + "RealWorthTM & more details!!" + "</p>"
//                } else if (arrDestinations[i].isForSell === 'Y' && arrDestinations[i].marketBasedEst === 0) {
//                    htmlContent = "<a href=\"#business_details/" + arrDestinations[i].businessId + "\"><img src=\"" + arrDestinations[i].imageFirst + "\" style=\"width:200px;height:100px\" class=\"img-fluid\" alt=\"\"><p style=\"margin:0px;color:black;\">" + arrDestinations[i].name + "</p><p ng-if=\"arrDestinations[i].isForSell === \'Y\'\" style=\"margin:0px;color:black;\">" + "Asking Price: $" + arrDestinations[i].forSellPrice + "</p>"
                } else {
                    htmlContent = "<a href=\"#business_details/" + arrDestinations[i].businessId + "\"><img src=\"" + arrDestinations[i].imageFirst + "\" style=\"width:200px;height:100px\" class=\"img-fluid\" alt=\"\"><p style=\"margin:0px;color:black;\">" + arrDestinations[i].name + "</p><p style=\"margin:0px;color:blue;\">" + "RealWorth&trade; & more details!" + "</p>"
                }
